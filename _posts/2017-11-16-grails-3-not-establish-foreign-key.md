...
/**
 * 继承GrailsDomainBinder实现自定义Hibernate设置
 * @author 王宇
 */
public class MyGrailsDomainBinder extends GrailsDomainBinder {
    ...
    public MyGrailsDomainBinder(String dataSourceName, String sessionFactoryName, HibernateMappingContext hibernateMappingContext) {
    ...
    public Mapping evaluateMapping(PersistentEntity domainClass, Closure<?> defaultMapping, boolean cache) {
        return super.evaluateMapping(domainClass,defaultMapping,cache);
    }
